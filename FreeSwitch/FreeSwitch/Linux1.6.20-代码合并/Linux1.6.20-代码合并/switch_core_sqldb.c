...
static char create_channels_sql[] =
	...
	"   secure VARCHAR(64),\n"
	"   hostname VARCHAR(256),\n"
	"   presence_id VARCHAR(256),\n"
	"   presence_data VARCHAR(256),\n"
	...
	"   sent_callee_name  VARCHAR(256),\n"
	"   sent_callee_num  VARCHAR(256),\n"
	"   initial_cid_name  VARCHAR(256),\n"
